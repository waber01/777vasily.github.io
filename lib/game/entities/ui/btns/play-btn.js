ig.module
("game.entities.ui.btns.play-btn").requires
('impact.entity',"game.entities.ui.btns.button-base").defines(function()
{EntityPlayBtn=EntityButtonBase.extend({collides:ig.Entity.COLLIDES.NEVER,type:ig.Entity.TYPE.NONE,checkAgainst:ig.Entity.TYPE.NONE,size:{x:318,y:176},upImage:new ig.Image("media/images/ui/btns/play_btn_up.png"),downImage:new ig.Image("media/images/ui/btns/play_btn_up.png"),init:function(x,y,settings)
{this.parent(x,y,settings);this.offset.x=(318*0.5)-(this.size.x*0.5);this.offset.y=(176*0.5)-(this.size.y*0.5);this.currentImage=this.upImage;},changeImage:function($value,$playTween)
{switch($value)
...
{this.parent();this.changeImage("down",true);ig.game.handleEvent("playBtnClicked");},onMouseOver:function()
